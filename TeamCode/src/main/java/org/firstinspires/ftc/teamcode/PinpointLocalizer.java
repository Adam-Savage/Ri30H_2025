...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 5927.19284777618; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -11964.361299371612; // x position of the perpendicular encoder (in tick units)
    }
